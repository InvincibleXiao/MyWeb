...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container cl">
            ...
            <a class="logo navbar-logo-m visible-xs" href="index.jsp">王潇的博客</a>
			...
			for(Article article: arts){
             %>	
				<li class="index_arc_item">
					...
					<h4 class="title"><a href="../clickDetails?articleid=<%=article.getId()%>"><%=article.getTitle()%></a></h4>
					<div class="date_hits">
						
						<span><%=article.getPubDate()%></span>
						<span><a href="../clickDetails?articleid=<%=article.getId()%>">程序人生</a></span>
					...
					<div class="desc"><%=article.getContent()%></div>
				</li>
