		...
		<div class="row">
			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					...
					<div class="login">
						<div class="page-header" style="pause: 0px;"> <h1 class="login_h1">博客系统</h1> </div>
						<!-- 会员登录表单 -->
							...
							<fieldset>
								...
								<div class="form-group"
									...
									<label
										...
										<label
										style="float: right; color: #858585; margin-right: 40px; margin-top: 10px; font-size: 14px;"><a
										href="index.jsp">游客登录</a></label>
								</div>
							</fieldset>
						</form>
					</div>
